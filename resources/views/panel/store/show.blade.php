                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
							<div class="card">
							  ...
							  <div class="card-body">
                                <a href="{{ route('store.edit',[$store->point_sale_id,$store->product_id]) }}" class="btn btn-success btn-icon-split">
                                    <span class="icon text-white-50">
                                        <i class="fas fa-check"></i>
                                    </span>
                                    <span class="text">Edit</span>
                                </a>
                                <a href="#" class="btn btn-danger btn-icon-split" data-toggle="modal" data-target="#modal-{{ $store->point_sale_id }}-{{ $store->product_id }}">
                                    <span class="icon text-white-50">
